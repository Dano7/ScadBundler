...
/// </summary>
public sealed class OutputPanelTests : BunitContext
{
    ...
    {
        IRenderedComponent<OutputPanel> cut = Render<OutputPanel>(p => p
    ...
    public void ShowsErrorNotice_AndNoEmitButtons_WhenNotOk()
    {
        ...
        IRenderedComponent<OutputPanel> cut = Render<OutputPanel>(p => p.Add(c => c.Result, blocked));
    ...
    public void RendersNoButtonsOrError_WhenOkButEmpty()
    {
        ...
        IRenderedComponent<OutputPanel> cut = Render<OutputPanel>(p => p.Add(c => c.Result, empty));
    ...
    public void StatsLine_SurfacesRenamedAndRemoved_WhenProfileRan()
    {
        ...
        IRenderedComponent<OutputPanel> cut = Render<OutputPanel>(p => p.Add(c => c.Result, hardened));
    ...
    {
        IRenderedComponent<OutputPanel> cut = Render<OutputPanel>();
